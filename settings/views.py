...
from settings.forms import openaiSettingsForm, paymentMethodsForm
...
def adminOpenaiSettings(request):
    ...
    return render(request, 'crm/main/settings/ai.html', context)
...
def adminPaymentMethodsSettings(request):
    ...
    return render(request, 'crm/main/settings/payment_methods.html', context)
